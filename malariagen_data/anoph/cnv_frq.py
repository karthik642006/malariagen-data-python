...
class AnophelesCnvFrequencyAnalysis(AnophelesCnvData, AnophelesFrequencyAnalysis):
    ...
    def _gene_cnv(
        ...
        *,
        ...
        local_dict = dict(sample_query_options.pop("local_dict", {}))
        local_dict["_gff_gene_type"] = self._gff_gene_type
        df_genes = df_genome_features.query(
            "type == @_gff_gene_type", local_dict=local_dict, **sample_query_options
        )
