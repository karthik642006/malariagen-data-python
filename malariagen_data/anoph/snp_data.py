...
class AnophelesSnpData(
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Set up caches.
        self._cache_snp_sites: Optional[zarr.Group] = None
        self._cache_snp_genotypes: Dict[str, zarr.Group] = dict()
        self._cache_site_filters: Dict[str, zarr.Group] = dict()
        self._cache_site_annotations: Optional[zarr.Group] = None
