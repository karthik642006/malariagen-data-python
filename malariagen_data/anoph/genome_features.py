...
class AnophelesGenomeFeaturesData(AnophelesGenomeSequenceData):
            ...
            if region is not None:
                ...
                for r in regions:
                    ...
                    if r.end is not None:
                        df_part = df_part.query("start <= @r.end")
                    if r.start is not None:
                        df_part = df_part.query("end >= @r.start")
    ...
    def _plot_genes_setup_data(self, *, region):
        ...
        _gff_gene_type = self._gff_gene_type  # noqa: F841
        data = df_genome_features.query("type == @_gff_gene_type").copy()
