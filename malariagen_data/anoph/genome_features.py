...
class AnophelesGenomeFeaturesData(AnophelesGenomeSequenceData):
            ...
            if region is not None:
                ...
                for r in regions:
                    ...
                    if r.end is not None:
                        # assign to local variable because attributes are not supported in pandas query with @
    ...
    def _plot_genes_setup_data(self, *, region):
        ...
        gff_gene_type = self._gff_gene_type  # noqa: F841
        data = df_genome_features.query("type == @gff_gene_type").copy()
